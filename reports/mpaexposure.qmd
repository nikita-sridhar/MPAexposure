...
#calculate seasonal SD for each MPA
mpa_climatology <- mpa %>%
...
Interpolation for pH, historic time period
...
Interpolation for pH, mid century time period
...
Interpolation for pH, end century time period
