...
To understand how the number of events in a year changes with time, we represent the change in number of events between time periods in the following maps.
