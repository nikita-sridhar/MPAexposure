...
factors2 <- factors %>% 
  mutate(residual_hist_midcen = residuals(hist_midcen_mod),
         residual_hist_endcen = residuals(hist_endcen_mod),
         residual_midcen_endcen = residuals(midcen_endcen_mod),
         scaled_residual_hist_midcen = as.numeric(scale(residuals(hist_midcen_mod))),
         scaled_residual_hist_endcen =  as.numeric(scale(residuals(hist_endcen_mod))),
         scaled_residual_midcen_endcen =  as.numeric(scale(residuals(midcen_endcen_mod))),
...
bestfit <-lm(factors2$scaled_residual_hist_endcen ~ factors2$scaled_residual_hist_midcen)
...
ggplot(factors3, aes(x = scaled_residual_hist_midcen, y = scaled_residual_hist_endcen)) +
