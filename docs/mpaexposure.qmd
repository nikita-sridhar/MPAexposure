...
prob_of_pH_DO_event <- all_events %>%
  merge(num_mpa, by = "region") %>%
  group_by(julianday, period, Year, region) %>%
  filter(is_pH_and_DO_low == TRUE) %>%
  reframe(pH_DO_prob = mean(n_distinct(File), na.rm=TRUE)/num_mpa) %>%
  distinct(julianday, period, Year, region, pH_DO_prob) %>%
  ungroup()

prob_of_pH_DO_T_event <- all_events %>%
  merge(num_mpa, by = "region") %>%
  group_by(julianday, period, Year, region) %>%
  filter(is_pH_DO_and_T_low == TRUE) %>%
  reframe(pH_DO_T_prob = mean(n_distinct(File), na.rm=TRUE)/num_mpa) %>%
  distinct(julianday, period, Year, region, pH_DO_T_prob) %>%
  ungroup()
...
multi_event("historic","centralca","two")
multi_event("midcen","centralca","two")
multi_event("endcen","centralca","two")

multi_event("historic","centralca","three")
multi_event("midcen","centralca","three")
multi_event("endcen","centralca","three")
```
...
multi_event("historic","norca","two")
multi_event("midcen","norca","two")
multi_event("endcen","norca","two")

multi_event("historic","norca","three")
multi_event("midcen","norca","three")
multi_event("endcen","norca","three")
```
...
multi_event("historic","socal","two")
multi_event("midcen","socal","two")
multi_event("endcen","socal","two")

multi_event("historic","socal","three")
multi_event("midcen","socal","three")
multi_event("endcen","socal","three")
```
...
multi_event("historic","channel","two")
multi_event("midcen","channel","two")
multi_event("endcen","channel","two")

multi_event("historic","channel","three")
multi_event("midcen","channel","three")
multi_event("endcen","channel","three")
```
